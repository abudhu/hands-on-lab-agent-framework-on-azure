...
def main():
    ...
    ms_learn_agent = AzureAIAgentClient(**settings).create_agent(
        ...
        tools=HostedMCPTool(
            ...
            url="https://learn.microsoft.com/api/mcp?WT.mc_id=javascript-76678-cxa",
    ...
    serve(entities=[issue_analyzer_agent, github_agent, ms_learn_agent,
          workflow], port=8090, auto_open=True, tracing_enabled=True)
